    ...
    <div id="top" style="height:50px">
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
                    <li><a href="register.php" data-toggle="modal" data-target="#login-modal" style="height:35px; font-size:20px">Login</a>
                    </li>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">info@gobana.com</a></strong>
                                    </li>
